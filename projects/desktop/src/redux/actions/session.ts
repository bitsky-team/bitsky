 ...
 */
export const setLanguage: Function = (language: string): Function => async (dispatch: Function): Promise<Function> =>
 ...
 * @param token string
 */
export const setToken: Function = (token: string): Function => async (dispatch: Function): Promise<Function> =>
    new Promise((resolve: Function): void => {
        resolve(dispatch({
            payload: { token },
            type: SET_TOKEN,
